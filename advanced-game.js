...
const PLANETS = {
  space:{name:"الفضاء المفتوح",en:"SOLAR SYSTEM FLIGHT",icon:"🚀",gravity:0,type:"رحلة في الفضاء",color:"#63e6f5",sky:["#01030b","#06142a"],ground:"#020713",fact:"حرّك المركبة واختار الكوكب اللي عايز تروحه.",detail:"قرّب من أي كوكب. اضغط E عشان تبدأ مهمته.",mode:"space"},
  moon:{name:"القمر",en:"MOON",icon:"🌙",gravity:.165,type:"قمر الأرض",color:"#aeb7bf",sky:["#01040b","#080d18"],ground:"#777b80",fact:"الجاذبية هي القوة اللي بتشدك للأرض. جاذبيتي سدس جاذبية الأرض، عشان كده بتنط أعلى هنا!",detail:"أنا القمر اللي بيلف حوالين الأرض. أنا مش كوكب.",personality:"أهلًا! أنا القمر. نورت الحفر الكبيرة اللي عندي يا رائد الفضاء!",hasRing:false,ringReply:"لأ، مفيش حلقة من حلقات زحل هنا.",clue:"بس شوف! حلقة راحت ناحية المريخ. روح وراها!",tool:"scoop",mode:"surface"},
  mercury:{name:"عطارد",en:"MERCURY",icon:"☿",gravity:.38,type:"كوكب صخري",color:"#918b82",sky:["#040405","#171617"],ground:"#625f5a",fact:"أنا أصغر كوكب، وأنا أقرب كوكب للشمس.",detail:"بلف حوالين نفسي ببطء. اللفة الواحدة بتاخد حوالي 59 يوم من أيام الأرض. وحواليّ هوا قليل جدًا.",personality:"أنا عطارد! صغير وقريب جدًا من الشمس.",hasRing:true,ringReply:"أيوه! شفت حلقة من حلقات زحل هنا.",clue:"قِس الحرارة الأول. بعدين دور عليها عند الحفرة الكبيرة البعيدة.",ringLine:"عرفت إن عطارد أقرب كوكب للشمس. حرارته عالية جدًا في النور، وباردة جدًا في الضلمة!",tool:"temperatureProbe",mode:"surface"},
  venus:{name:"الزهرة",en:"VENUS",icon:"🟡",gravity:.9,type:"كوكب صخري",color:"#d7c07f",sky:["#29271f","#77705a"],ground:"#8c8066",fact:"سحبي بترجّع ضوء الشمس، عشان كده ببان لامعة. والهوا الكتير حواليا بيخلي الحرارة تفضل جوه.",detail:"أنا بلف عكس أغلب الكواكب. المكان هنا سخن وضغط الهوا قوي، عشان كده هنفحص الصخور من مكان أأمن.",personality:"أنا الزهرة! لامعة وجميلة، بس الجو عندي سخن جدًا. 🔥",hasRing:true,ringReply:"أيوه! شفت حلقة من حلقات زحل هنا.",clue:"خد قطعة من الصخر الأول. بعدين دور على الحلقة في آخر الطريق.",ringLine:"عرفت إن الزهرة من أسخن الكواكب. الهوا الكتير حواليها بيخلي الحرارة تفضل جوه!",tool:"rockHammer",mode:"surface"},
  earth:{name:"الأرض",en:"EARTH",icon:"🌍",gravity:1,type:"كوكب صخري",color:"#2789b8",sky:["#4aaee0","#e5f4df"],ground:"#c9b77f",fact:"الميه بتغطي حوالي 71% من سطحي. والهوا حواليا بيساعد الكائنات تعيش.",detail:"جوايا أربع طبقات. اسمهم القشرة، والوشاح، واللب الخارجي، واللب الداخلي.",personality:"أنا الأرض، بيتك الأزرق! أهلًا بيك عند البحر.",hasRing:true,ringReply:"أيوه! حلقة من حلقات زحل دخلت البحر واختفت تحت الميه.",clue:"ادخل البحر من الشاطئ. انزل تحت الميه. اسمع الإشارة وروح ناحيتها.",ringLine:"عرفت إن الميه السائلة والمحيطات بيساعدوا كائنات كتير تعيش!",tool:"hydrophone",mode:"surface"},
  mars:{name:"المريخ",en:"MARS",icon:"🔴",gravity:.38,type:"كوكب صخري",color:"#a5573d",sky:["#6f5050","#d0aa82"],ground:"#8b5a42",fact:"أنا كوكب صخري. الهوا حواليا قليل، وترابي أحمر بسبب الحديد.",detail:"جاذبيتي 38% من جاذبية الأرض. وعندي أكبر بركان معروف.",personality:"أهلًا يا رائد الفضاء! أنا المريخ، الكوكب الأحمر. 🔴",hasRing:true,ringReply:"أيوه! شفت حلقة من حلقات زحل هنا.",clue:"خد عينة من الصخر الأول. بعدين دور على الحلقة عند الحفرة البعيدة.",ringLine:"عرفت إن تراب المريخ أحمر بسبب الحديد اللي صدّي!",tool:"drill",mode:"surface"},
  jupiter:{name:"المشتري",en:"JUPITER ORBIT",icon:"🟠",gravity:2.53,type:"كوكب غازي ضخم",color:"#c88f68",sky:["#020715","#10182c"],ground:"#18243c",fact:"أنا أكبر كوكب. يومي قصير: حوالي 9.9 ساعات بس.",detail:"أنا كرة غاز ضخمة، ومفيش عندي أرض صلبة تهبط عليها. هتطير فوق السحب والبقعة الحمراء.",personality:"أنا المشتري! ضخم جدًا، ومفيش عندي أرض تهبط عليها! 😄",hasRing:true,ringReply:"أيوه! شفت حلقة من حلقات زحل بتجري قرب سحبي.",clue:"الإشعاع هنا ممكن يؤذيك. قِسه واختار الطريق اللي رقمه أقل. دور على الحلقة في آخره.",ringLine:"عرفت إن المشتري أكبر كوكب. هو كرة غاز ضخمة من غير أرض صلبة!",tool:"radiation",mode:"orbit"},
  uranus:{name:"أورانوس",en:"URANUS ORBIT",icon:"⛢",gravity:.89,type:"كوكب جليدي ضخم",color:"#72ced5",sky:["#020c16","#153b4c"],ground:"#325f6a",fact:"أنا كوكب جليدي ضخم وبارد. غاز اسمه الميثان بيساعدني أبان أزرق.",detail:"أنا بلف كأني نايم على جنبي. هتطير حواليا قرب الحلقات الرفيعة.",personality:"أنا أورانوس! بلف وأنا مايل على جنبي.",hasRing:true,ringReply:"أيوه! شفت حلقة من حلقات زحل بتعدي من هنا.",clue:"شغّل جهاز تحديد الاتجاه. امشِ ورا العلامات لحد آخر الطريق.",ringLine:"عرفت إن أورانوس كوكب جليدي ضخم، وبيلف كأنه نايم على جنبه!",tool:"navigation",mode:"orbit"},
  neptune:{name:"نبتون",en:"NEPTUNE ORBIT",icon:"♆",gravity:1.14,type:"كوكب جليدي ضخم",color:"#315fcb",sky:["#010616","#10245a"],ground:"#1f3f83",fact:"أنا أبعد كوكب عن الشمس. وعندي رياح سريعة جدًا.",detail:"حواليا حلقات رفيعة وقطع منها على شكل أقواس. الجو بارد جدًا، فدفّي أجهزتك.",personality:"أنا نبتون! أزرق وبعيد، ورياحي سريعة جدًا.",hasRing:true,ringReply:"أيوه! شفت حلقة من حلقات زحل في المكان الضلمة.",clue:"شغّل الكشاف ودفّي الأجهزة. بعدين دور على الحلقة في آخر الطريق.",ringLine:"عرفت إن نبتون أبعد كوكب عن الشمس، وعنده رياح سريعة جدًا!",tool:"heater",mode:"orbit"},
  saturn:{name:"زحل",en:"SATURN ORBIT",icon:"🪐",gravity:1.06,type:"كوكب غازي ضخم",color:"#d0a35c",sky:["#070714","#2d2430"],ground:"#4d3e45",fact:"أنا سادس كوكب من الشمس، وثاني أكبر كوكب.",detail:"أنا كرة غاز من الهيدروجين والهيليوم. مفيش عندي أرض صلبة تقف عليها.",personality:"أنا زحل! أهلًا بيك حواليا. لقيت حلقاتي السبع؟",hasRing:false,ringReply:"مفيش حلقة هنا دلوقتي. اجمع الحلقات السبع وارجع لي.",clue:"روح للكواكب. اجمع الحلقات السبع. وبعدين ارجع لزحل.",tool:"magnetometer",mode:"orbit"}
};
...
const PLANET_DIALOGUES = {
  mercury:[
    {astronaut:true,text:"السما سودا والحفر في كل مكان! يا عطارد، شفت حلقة من حلقات زحل؟"},
    {text:"أيوه. راحت ناحية الحفرة الكبيرة البعيدة. بس الشمس هنا قوية جدًا."},
    {astronaut:true,text:"أعرف فرق الحرارة بين الصخر اللي في الشمس والصخر اللي في الضلمة إزاي؟"},
    {text:"خد جهاز قياس الحرارة. حطه على الصخر اللي في الشمس. استنى لحد ما الرقم يثبت. بعدين قِس الصخر اللي في الضلمة."},
    {astronaut:true,text:"تمام. هقارن الرقمين عشان أعرف الفرق."},
    {text:"لما تخلص القياسين، روح للحفرة الكبيرة البعيدة. هتلاقي الحلقة هناك."}
  ],
  venus:[
    {astronaut:true,text:"الحرارة هنا عالية جدًا! يا زهرة، شفت حلقة من حلقات زحل؟"},
    {text:"أيوه. راحت ورا الصخور البعيدة. خد مطرقة الصخور وملقاط العينات وعلبة العينات الأول."},
    {astronaut:true,text:"أستخدم الأدوات دي إزاي من غير ما أوسّخ العينة؟"},
    {text:"اضرب الصخرة ثلاث ضربات. امسك القطعة بالملقاط. حطها في العلبة. اقفل العلبة وحط عليها بطاقة المكان."},
    {astronaut:true,text:"شايف جبال وصخور عملتها البراكين. الحلقة راحت ناحيتهم؟"},
    {text:"أيوه. احفظ العينة كويس. بعدين روح ورا النور عند الصخور البعيدة."}
  ],
  earth:[
    ...
    {text:"خد جهاز سماع الإشارات. ادخل البحر من الشاطئ اليمين. انزل قرب القاع. اسمع الإشارات وروح ناحية الأقوى."},
    {astronaut:true,text:"تمام! هسبح يمين. هنزل تحت الميه وأروح ناحية أقوى إشارة."},
    {text:"بعد جهاز الإشارة، كمّل ناحية النور الدهبي في أعمق مكان. الحلقة هناك."}
  ],
  moon:[
    {text:"أهلًا بيك على القمر! الجاذبية هي القوة اللي بتشدك للأرض. جاذبيتي سدس جاذبية الأرض، عشان كده بتحس إنك أخف هنا!"},
    {astronaut:true,text:"آه! عشان كده حركتي أخف وبنط أعلى هنا؟"},
    {text:"بالضبط! جسمك لسه زي ما هو. بس القمر بيشدك بقوة أقل، عشان كده وزنك هنا أقل وبتنط أعلى."},
    {astronaut:true,text:"وأنا بستكشف المجموعة الشمسية عشان أساعد زحل وأرجّع له حلقاته السبع. شفت واحدة منهم هنا؟"},
    {text:"أنا القمر اللي بيلف حوالين الأرض. أنا مش كوكب، ومفيش حلقة هنا. بس شفت حلقة رايحة ناحية المريخ. افحص تراب الحفرة الأول، وبعدها روح للمريخ."},
    {astronaut:true,text:"هفحص التربة بإيه، وأجهّز الأداة إزاي؟"},
    {text:"خد مغرفة التراب. اجمع شوية تراب من الحفرة. حطه في علبة العينات. اقفل العلبة وحط عليها بطاقة المكان. عند علامة العمل، اختار الأداة من الشنطة واضغط E."},
    {astronaut:true,text:"تمام! هجمع التربة وأحفظها صح، وبعدها هتبع بريق الحلقة ناحية المريخ."}
  ],
  mars:[
    {astronaut:true,text:"يا مريخ، المكان ده شكله كان فيه ميه زمان. شفت حلقة من حلقات زحل؟"},
    {text:"أيوه. راحت ناحية الوادي البعيد. هتلاقيها عند حفرة صغيرة بعد الوادي."},
    {astronaut:true,text:"أعرف إزاي إن الميه كانت هنا فعلًا؟"},
    {text:"خد مثقاب الصخور. روح للصخر عند طرف المكان الجاف. احفر بالراحة وطلّع عينة من جوه الصخر في الأنبوب."},
    {astronaut:true,text:"تمام، هفحص الطبقات اللي جوه الصخر وأحافظ على العينة زي ما هي."},
    {text:"اقفل الأنبوب وحط عليه بطاقة المكان. بعدين اعدّي الوادي وروح للحفرة الصغيرة. الحلقة هناك."}
  ],
  jupiter:[
    {astronaut:true,text:"يا مشتري، شوفت حلقة من حلقات زحل مرّت من هنا؟"},
    {text:"أيوه! كانت قرب سحبي، وراحت ناحية الطريق البعيد."},
    {astronaut:true,text:"أقدر أوصل لها بأمان منين؟"},
    {text:"⚠️ الإشعاع هنا عالي، خليك حذر! الإشعاع طاقة ممكن تؤذيك. شغّل جهاز القياس هنا. بعدين قِس المكان التاني. اختار الطريق اللي رقمه أقل. ده الطريق الأأمن للحلقة."},
    {astronaut:true,text:"تمام. هقيس المكانين واختار الرقم الأقل."},
    {text:"صح! في إشعاع قوي حواليا. الطريق اللي رقمه أقل أأمن."}
  ],
  saturn:[
    {astronaut:true,text:"يا زحل، وصلت عندك. رجعت لك أي حلقة؟"},
    {text:"لسه. الحلقات السبع موجودة عند كواكب مختلفة."},
    {astronaut:true,text:"هكمل أدور عليهم. بس قولي: إيه اللي يميزك؟"},
    {text:"أنا ثاني أكبر كوكب. عرضي حوالي تسع مرات عرض الأرض. وأنا كرة غاز من الهيدروجين والهيليوم."},
    {astronaut:true,text:"هقيس القوة المغناطيسية حواليك قبل ما أمشي."},
    {text:"قِسها بأمان. لما تجمع الحلقات السبع، ارجع لي هنا. أنا بلف حوالين الشمس مرة كل 29.5 سنة من سنين الأرض."},
  ...
  uranus:[
    ...
    {astronaut:true,text:"الطريق هنا مايل. أوصل لها إزاي؟"},
    {text:"شغّل جهاز تحديد الاتجاه. روح للعلامة الأولى، وبعدها العلامة التانية. خليك على نفس الاتجاه لحد آخر الطريق."},
    {astronaut:true,text:"تمام. همشي ورا العلامات ومش هغيّر اتجاهي."},
    {text:"بص على اتجاهك كويس. ميل الكوكب ممكن يلخبطك."}
  ],
  neptune:[
    {astronaut:true,text:"يا نبتون، شفت آخر حلقة من حلقات زحل في المنطقة دي؟"},
    {text:"شفت نور حلقة في المكان الضلمة. راحت ناحية الأجهزة البعيدة."},
    {astronaut:true,text:"إزاي أتبعها وسط الظلام والبرد؟"},
    {text:"شغّل الكشاف عشان تشوف. دفّي الأجهزة عشان تشتغل. بعدين دور في آخر الطريق."},
    {astronaut:true,text:"تمام. هنور المكان، وأدفّي الأجهزة، وأكمل."},
    {text:"خلي الكشاف شغال والأجهزة دافية. امشِ ورا الإشارة لآخر الطريق. الحلقة هناك."}
  ]
};
const RING_DIALOGUES = {
  mercury:[
    ...
    {speaker:"ring",text:"عطارد أصغر كوكب وأقرب كوكب للشمس. معندوش أقمار ولا حلقات. سنته 88 يوم من أيام الأرض. وبيلف حوالين نفسه مرة كل 59 يوم. حواليه هوا قليل جدًا."},
    {speaker:"astronaut",text:"يعني حرارته مش واحدة طول الوقت؟ وشفت حاجات فاتحة جوه حفرة ضلمة. دي إيه؟"},
    {speaker:"ring",text:"دي علامة على وجود تلج من الميه! التلج مستخبي في حفر عند طرف الكوكب. الشمس تقريبًا مش بتوصل لهناك، عشان كده التلج ما بيدوبش."},
  ...
  venus:[
    ...
    {speaker:"ring",text:"الهوا حوالين الزهرة اسمه الغلاف الجوي. معظمه غاز اسمه ثاني أكسيد الكربون. الغاز ده بيخلي الحرارة تفضل جوه، زي البطانية. عشان كده السطح حوالي 470 درجة! وضغط الهوا أقوى من الأرض 92 مرة."},
    {speaker:"astronaut",text:"كل ده بسبب الهوا حوالين الزهرة؟ طب والجبال والصخور دي؟"},
    {speaker:"ring",text:"عند الزهرة أكتر من ألف بركان معروف. بعض جباله أعلى من 11 كيلومتر. سحبه بترجّع ضوء الشمس، عشان كده بيلمع. هو كمان بيلف عكس أغلب الكواكب. يومه أطول من سنته، وسنته حوالي 225 يوم من أيام الأرض."},
  ...
  earth:[
    ...
    {speaker:"ring",text:"أيوه! أنا واحدة من حلقات زحل. فضلت أشوف المحيط، لأن الأرض فيها ميه سائلة كتير."},
    {speaker:"astronaut",text:"المحيط واسع أوي! هو واخد مساحة كبيرة من الأرض؟"},
    {speaker:"ring",text:"أيوه! المحيطات بتغطي حوالي 71% من سطح الأرض. عشان كده الأرض بتبان زرقا من الفضاء."},
    {speaker:"astronaut",text:"وكل السمك والنباتات اللي قابلتهم عايشين في العالم الكبير ده؟"},
    {speaker:"ring",text:"بالضبط! كائنات كتير بتعيش في المحيطات. والهوا حوالين الأرض بيساعد الميه تفضل سائلة. جوا الأرض أربع طبقات: القشرة برا، وبعدها الوشاح، وبعدها اللب الخارجي، وفي النص اللب الداخلي."},
  ...
  mars:[
    ...
    {speaker:"ring",text:"صح! عديت جنب بركان ضخم اسمه أوليمبوس مونس. وشفت وادي كبير ومكان جاف فيه طبقات ومجاري ميه قديمة."},
    {speaker:"astronaut",text:"هو الميه كانت موجودة هنا قبل كده؟ وليه التراب أحمر كده؟"},
    {speaker:"ring",text:"زمان، المريخ كان أدفى وفيه ميه أكتر. مجاري الميه والتراب اللي سابته البحيرات بيدلوا إن ميه سائلة كانت هنا. ولونه أحمر لأن الحديد في التراب صدّي."},
    {speaker:"astronaut",text:"هو التراب هنا ممكن يطير بالعواصف؟ وإيه النقطتين الصغيرين في السما؟"},
    {speaker:"ring",text:"الهوا حوالين المريخ قليل، ومعظمه ثاني أكسيد الكربون. الرياح بتطير التراب، والحرارة بتتغير بسرعة. جاذبيته 38% من جاذبية الأرض. النقطتين هما قمراه: فوبوس وديموس. يوم المريخ اسمه سول، وطوله 24.6 ساعة."},
  ...
  jupiter:[
    ...
    {speaker:"ring",text:"بالضبط! دي البقعة الحمراء الكبيرة. هي عاصفة أكبر من الأرض كلها، وبقالها مئات السنين!"},
    {speaker:"astronaut",text:"واضح إن المشتري مش بيحب الهدوء! وإيه كمان؟"},
    {speaker:"ring",text:"المشتري أكبر كوكب، وعنده أقصر يوم. يومه 9.9 ساعات، يعني حوالي عشر ساعات بس. بيلف حوالين الشمس مرة كل 12 سنة من سنين الأرض. وعنده قوة مغناطيسية كبيرة جدًا حواليه."},
  ...
  uranus:[
    ...
    {speaker:"ring",text:"أورانوس كوكب جليدي ضخم وبارد جدًا. غاز اسمه الميثان بيساعده يبان أزرق. حواليه حلقات رفيعة وغامقة. والأغرب إنه مايل على جنبه 98 درجة."},
    {speaker:"astronaut",text:"يعني فعلًا بيلف كأنه نايم على جنبه؟"},
    {speaker:"ring",text:"تقريبًا! عشان هو مايل، كل فصل عنده طويل جدًا. الفصل الواحد ممكن يكمل 21 سنة من سنين الأرض."},
  ...
  neptune:[
    ...
    {speaker:"ring",text:"عنده رياح من أسرع رياح الكواكب. سرعتها ممكن تعدّي 2000 كيلومتر في الساعة!"},
    {speaker:"astronaut",text:"مذهل! ولونه الأزرق جاي منين؟"},
    {speaker:"ring",text:"غاز الميثان بياخد جزء من اللون الأحمر في الضوء، فده بيساعد نبتون يبان أزرق. العلماء لسه بيدرسوا سبب اللون الأزرق الغامق. حواليه حلقات رفيعة وقطع منها على شكل أقواس. سنته 165 سنة من سنين الأرض!"},
    {speaker:"astronaut",text:"دي الحلقة السابعة! دلوقتي دوري أرجع السبع حلقات لزحل وأكمل المهمة."}
  ]
};
const DISCOVERY_MOMENTS = {
  mercury:{title:"ANCIENT IMPACT CRATER",fact:"الحفر في كل مكان! عطارد معندوش أقمار ولا حلقات. بيلف حوالين نفسه مرة كل 59 يوم من أيام الأرض."},
  venus:{title:"DENSE CLOUD LAYERS",fact:"سحب الزهرة بترجّع ضوء الشمس، عشان كده الكوكب بيلمع. والهوا الكتير حواليه بيخليه سخن جدًا."},
  earth:{title:"THE LIVING OCEAN",fact:"المحيطات بتغطي 71% من الأرض. وجوا الأرض أربع طبقات: القشرة، والوشاح، واللب الخارجي، واللب الداخلي."},
  moon:{title:"EARTHRISE",fact:"من عند طرف القمر، الأرض بتبان بعيدة ومختلفة جدًا."},
  mars:{title:"OLYMPUS MONS",fact:"أوليمبوس مونس بركان ضخم على المريخ. هو من أكبر البراكين المعروفة."},
  jupiter:{title:"THE GREAT RED SPOT",fact:"البقعة الحمراء عاصفة أكبر من الأرض. ويوم المشتري قصير: 9.9 ساعات بس."},
  saturn:{title:"RINGS IN PERSPECTIVE",fact:"تقدر تشوف زحل كنقطة منورة بعينك. لكن عشان تشوف حلقاته بوضوح، محتاج تلسكوب."},
  uranus:{title:"AN EXTREME TILT",fact:"أورانوس كوكب جليدي ضخم. الميثان بيساعده يبان أزرق، وهو بيلف كأنه نايم على جنبه."},
  neptune:{title:"SUPERSONIC WINDS",fact:"عند نبتون رياح من أسرع رياح الكواكب. وحواليه حلقات رفيعة وقطع منها على شكل أقواس."}
};
const SPACE_REFERENCE = [
  {title:"معلومات عن الفضاء",code:"COSMIC BASICS",entries:[
    ["المجرة","مكان ضخم جدًا فيه مليارات النجوم، ومعاهم غاز وتراب ومادة مش بنشوفها اسمها المادة المظلمة. الجاذبية بتشد كل ده لبعضه."],
    ["المجموعة الشمسية","الشمس نجم في النص. حواليها ثمانية كواكب، وكمان أقمار وكويكبات ومذنبات وكواكب قزمة."],
    ["النجم والكوكب","النجم كرة سخنة جدًا بتعمل نور وطاقة. الكوكب بيلف حوالين نجم، ومابيعملش نور من نفسه. هو بيرجّع نور النجم."],
    ["الجاذبية","قوة بتشد الحاجات لبعضها. هي اللي مثبتانا على الأرض، وبتخلي الأقمار تلف حوالين الكواكب والكواكب تلف حوالين الشمس."]
  ]},
  {title:"حاجات في الفضاء",code:"OBJECTS & TOOLS",entries:[
    ["المذنب والكويكب","المذنب فيه تلج وتراب، وممكن يظهر له ذيل لما يقرب من الشمس. الكويكب قطعة صخر أو معدن. فيه كويكبات كتير بين المريخ والمشتري."],
    ["الشهاب والحجر النيزكي","لما حجر صغير يدخل الهوا حوالين الأرض، بيسخن وينور. ساعتها بنسميه شهاب. لو جزء منه وصل للأرض، بنسميه حجر نيزكي."],
    ["الكوكب القزم","جسم شبه الكورة بيلف حوالين الشمس. لكنه بيشارك طريقه مع أجسام تانية. بلوتو أشهر كوكب قزم."],
    ["الثقب الأسود","مكان جاذبيته قوية جدًا. لو حاجة قربت منه زيادة، حتى النور ما يقدرش يهرب."],
    ["الأقمار والتلسكوب","القمر الطبيعي بيلف حوالين كوكب. القمر الصناعي جهاز بيعمله الإنسان للاتصال ومعرفة الطقس وتحديد المكان والبحث. التلسكوب بيساعدنا نشوف الحاجات البعيدة في الفضاء."]
  ]},
  {title:"أول رحلات الفضاء",code:"SPACE MILESTONES",entries:[
    ["1957 · سبوتنيك 1","أول قمر صناعي عمله الإنسان ولف حوالين الأرض."],
    ["1961 · يوري جاجارين","أول إنسان راح الفضاء. سافر في مركبة اسمها فوستوك 1."],
    ["1969 · أبولو 11","في 20 يوليو، نيل أرمسترونج بقى أول إنسان يمشي على القمر."],
    ["مركبات الفضاء","الصاروخ بيدي القوة اللي ترفع المركبة للفضاء. المركبة ممكن يكون جواها ناس أو تشتغل لوحدها. المحطة الفضائية مكان بيلف حوالين الأرض، والرواد بيعيشوا ويشتغلوا جواه."]
  ]},
  {title:"حياة رائد الفضاء",code:"ASTRONAUT LIFE",entries:[
    ["التدريب والشغل","الرواد بيتدربوا سنين. بيتعلموا العلوم والأجهزة والعمل مع الفريق والتصرف وقت الخطر. وفي الفضاء بيعملوا تجارب، ويصلحوا الأجهزة، ويسوقوا المركبات."],
    ["بدلة الفضاء","البدلة بتدي الرائد أكسجين، وتحافظ على ضغط وحرارة جسمه، وتخليه يتكلم مع الفريق. كمان بتحميه من البرد والحر والإشعاع. الإشعاع طاقة ممكن تؤذي الجسم."],
    ["النوم والنظافة","الرائد بينام حوالي ثماني ساعات في كيس نوم مربوط. وبينضف جسمه بإسفنجة مبلولة ومناشف وشامبو جاف. وبيستخدم معجون أسنان مناسب للفضاء."],
    ["الرياضة والكلام","الرواد بيلعبوا رياضة حوالي ساعتين كل يوم عشان عضلاتهم وعظامهم يفضلوا أقوياء. وبيتكلموا بالراديو. الميكروفون والسماعات موجودين جوه الخوذة."],
    ["المخاطر","الإشعاع ممكن يؤذي الجسم. وقلة الجاذبية ممكن تضعّف العضلات والعظام. كمان الرائد بيكون بعيد لوحده، ووصول الأكل والمعدات بيبقى أصعب كل ما يبعد عن الأرض."]
  ]},
  {title:"زحل الحقيقي",code:"SATURN FACTS",entries:[
    ["مكانه وحجمه","زحل سادس كوكب من الشمس، وثاني أكبر كوكب. عرضه حوالي تسع مرات عرض الأرض. بيلف حوالين الشمس مرة كل 29.5 سنة من سنين الأرض."],
    ["الهوا حوالين زحل","زحل كرة غاز ضخمة، ومفيش عنده أرض صلبة. حواليه هيدروجين وهيليوم، ومعاهم كمية صغيرة من الأمونيا والميثان وبخار الميه. وفي سحبه رياح وعواصف قوية."],
    ["حلقات زحل","الحلقات فيها مليارات القطع من التلج والصخر والتراب. فيه قطع صغيرة جدًا، وفيه قطع قد البيت. الحلقات الكبيرة اسمها A وB وC، ومعاهم D وE وF وG وآلاف الشرائط الأصغر."],
    ["لون الحلقات","التلج بيرجّع ضوء الشمس، عشان كده الحلقات بتبان فاتحة. تقدر تشوف زحل كنقطة منورة بعينك. لكن عشان تشوف الحلقات بوضوح، محتاج تلسكوب."],
    ["أقمار زحل","في أغسطس 2026، كان عند زحل 293 قمر معروف. منهم تيتان وإنسيلادوس وريا وديون وإيابيتوس."],
    ["بايونير 11","بايونير 11 كانت أول مركبة تعدّي قرب زحل. ده حصل يوم 1 سبتمبر 1979. بعتت صور ومعلومات عن زحل وحلقاته وأقماره."]
  ]}
];
const ITEMS = {
  rockHammer:{name:"مطرقة الصخور",icon:"RH",purpose:"المطرقة دي بتطلع حتة صغيرة من الصخرة عشان تفحصها.",use:"امسك المقبض واضرب الصخرة ثلاث ضربات بهدوء.",weight:1,condition:100},
  scoop:{name:"مغرفة التراب",icon:"SC",purpose:"المغرفة دي بتجمع شوية تراب من سطح الكوكب.",use:"نزّل المغرفة، اجمع التراب، وبعدها ارفعه لعلبة العينات.",weight:1,condition:100},
  tongs:{name:"ملقاط العينات",icon:"TG",purpose:"الملقاط ده بيمسك القطع الصغيرة من غير ما تلمسها بإيدك.",use:"افتح الملقاط حوالين العينة، اقفله، وبعدها انقل العينة.",weight:1,condition:100},
  sampleContainer:{name:"علبة العينات",icon:"CAN",purpose:"العلبة دي بتحفظ العينة نضيفة ومقفولة.",use:"حط العينة جواها، اقفل الغطا، وبعدها حط بطاقة الاسم.",weight:1,condition:100},
  temperatureProbe:{name:"جهاز قياس الحرارة",icon:"TEMP",purpose:"الجهاز ده بيقيس حرارة الصخر بدل ما نخمنها.",use:"حط طرف الجهاز على السطح واستنى لحد ما الرقم يثبت.",weight:1,condition:100},
  drill:{name:"مثقاب الصخور",icon:"DRL",purpose:"المثقاب ده بيطلع عينة صغيرة من جوه الصخر.",use:"ثبّت المثقاب على الصخر، احفر بالراحة، وبعدها اسحب أنبوب العينة.",weight:2,condition:100},
  hydrophone:{name:"جهاز سماع الإشارات",icon:"HYD",purpose:"الجهاز ده بيسمع الإشارات تحت الميه ويعرف جاية منين.",use:"وجّه الجهاز بعيد عن البدلة واستنى أقوى إشارة.",weight:1,condition:100},
  camera:{name:"كاميرا الاستكشاف",icon:"CAM",purpose:"الكاميرا دي بتصور المكان والعينة قبل ما تغيّر أي حاجة.",use:"ثبّتها قدام الخوذة ووجّه العدسة ناحية الهدف.",weight:1,condition:100},
  flashlight:{name:"كشاف",icon:"LAMP",purpose:"الكشاف ده بينور الأماكن الضلمة عشان تشوف الأجهزة والسحب.",use:"امسكه في إيدك ووجّه النور ناحية الهدف.",weight:1,condition:100},
  navigation:{name:"جهاز تحديد الاتجاه",icon:"NAV",purpose:"الجهاز ده بيساعدك تعرف الاتجاه الصح وتثبت مسارك.",use:"وجّه الجهاز ناحية كل منارة واستنى لحد ما الاتجاه يثبت.",weight:2,condition:100},
  radiation:{name:"جهاز قياس الإشعاع",icon:"RAD",purpose:"الجهاز ده بيقيس الإشعاع ويساعدك تختار الطريق الأأمن.",use:"بعّد الجهاز عن البدلة واستنى لحد ما الرقم يظهر.",weight:2,condition:100},
  heater:{name:"دفاية الأجهزة",icon:"HEAT",purpose:"الدفاية دي بترجّع الجهاز البارد لحرارة تشغيل مناسبة.",use:"ثبّتها على الجهاز وشغّلها لحد ما حرارته تبقى مناسبة.",weight:2,condition:100},
  magnetometer:{name:"جهاز قياس المجال المغناطيسي",icon:"MAG",purpose:"الجهاز ده بيقيس قوة المجال المغناطيسي حوالين الكوكب.",use:"بعّد الجهاز عن معادن البدلة ووجّهه ناحية الكوكب لحد ما الرقم يثبت.",weight:2,condition:100}
};
...
const TOOL_WORKFLOWS={
  rockHammer:{pose:"hammer",duration:3.4,phases:[{id:"aim",label:"قف كويس واختار مكان الضربة",at:0},{id:"strike-1",label:"الضربة 1 من 3",at:.16,sound:"impact"},{id:"strike-2",label:"الضربة 2 من 3",at:.35,sound:"impact"},{id:"strike-3",label:"الضربة 3 من 3",at:.54,sound:"impact"},{id:"reveal",label:"ظهرت قطعة صخر جديدة",at:.72},{id:"inspect",label:"القطعة جاهزة تاخدها",at:.88}]},
  scoop:{pose:"scoop",duration:3.2,phases:[{id:"lower",label:"نزّل المغرفة ناحية التراب",at:0},{id:"collect",label:"اجمع طبقة تراب رقيقة",at:.25,sound:"soil"},{id:"lift",label:"ارفع المغرفة بهدوء",at:.53},{id:"transfer",label:"انقل التراب لعلبة العينات",at:.76,sound:"transfer"},{id:"ready",label:"العينة جاهزة للقفل",at:.92}]},
  tongs:{pose:"tongs",duration:3.1,phases:[{id:"reach",label:"قرّب الملقاط من القطعة",at:0},{id:"open",label:"افتح طرفي الملقاط",at:.22},{id:"grip",label:"امسك العينة بالراحة",at:.42,sound:"click"},{id:"transfer",label:"انقلها لعلبة العينات",at:.68,sound:"transfer"},{id:"ready",label:"العينة جوه العلبة",at:.9}]},
  sampleContainer:{pose:"container",duration:2.9,phases:[{id:"transfer",label:"حط العينة جوه العلبة",at:0,sound:"transfer"},{id:"seal",label:"اقفل الغطا كويس",at:.38,sound:"seal"},{id:"label",label:"حط بطاقة العينة",at:.68,sound:"label"},{id:"ready",label:"العينة محفوظة وجاهزة للفحص",at:.9}]},
  temperatureProbe:{pose:"probe",duration:3.2,phases:[{id:"aim",label:"وجّه طرف جهاز الحرارة",at:0},{id:"contact",label:"حط الجهاز على السطح",at:.25},{id:"measure",label:"استنى لحد ما الرقم يثبت",at:.46,sound:"measure"},{id:"reading",label:"اتسجلت درجة الحرارة",at:.82,sound:"reading"}]},
  drill:{pose:"drill",duration:3.6,phases:[{id:"brace",label:"امسك المثقاب كويس فوق الصخر",at:0},{id:"drill",label:"احفر جوه الصخر بالراحة",at:.2,sound:"drill"},{id:"extract",label:"اسحب أنبوب العينة",at:.62,sound:"extract"},{id:"ready",label:"عينة من جوه الصخر بقت في الأنبوب",at:.86}]},
  hydrophone:{pose:"sensor",duration:3.1,phases:[{id:"aim",label:"وجّه الجهاز جوه الميه",at:0},{id:"listen",label:"اسمع الإشارات",at:.26,sound:"measure"},{id:"compare",label:"قارن قوة الإشارات",at:.55},{id:"reading",label:"اتحدد اتجاه المنارة",at:.82,sound:"reading"}]},
  radiation:{pose:"sensor",duration:3,phases:[{id:"aim",label:"بعّد الجهاز عن البدلة",at:0},{id:"measure",label:"قِس الإشعاع",at:.32,sound:"measure"},{id:"reading",label:"ظهر رقم الإشعاع",at:.78,sound:"reading"}]},
  navigation:{pose:"sensor",duration:2.8,phases:[{id:"aim",label:"وجّه الجهاز ناحية المنارة",at:0},{id:"measure",label:"قارن اتجاه المسار",at:.34,sound:"measure"},{id:"reading",label:"اتثبت الاتجاه",at:.78,sound:"reading"}]},
  flashlight:{pose:"sensor",duration:2.6,phases:[{id:"aim",label:"وجّه الكشاف ناحية السحب",at:0},{id:"measure",label:"نوّر الطبقات الضلمة",at:.35,sound:"measure"},{id:"reading",label:"الصورة بقت واضحة",at:.8}]},
  heater:{pose:"service",duration:3,phases:[{id:"aim",label:"ثبّت الدفاية على الجهاز",at:0},{id:"measure",label:"زوّد الحرارة واحدة واحدة",at:.34,sound:"measure"},{id:"reading",label:"حرارة الجهاز بقت مناسبة",at:.8,sound:"reading"}]},
  magnetometer:{pose:"sensor",duration:3.1,phases:[{id:"aim",label:"بعّد الجهاز عن البدلة",at:0},{id:"measure",label:"استنى لحد ما الرقم يثبت",at:.32,sound:"measure"},{id:"reading",label:"اتسجلت قوة المجال",at:.8,sound:"reading"}]}
};
...
const MISSIONS={
  moon:{title:"LUNAR REGOLITH SAMPLE",kit:[["sampleContainer",1540]],steps:[["خد شوية تراب بالمغرفة",1250,485,"scoop"],["حط التراب في العلبة واقفلها",1820,465,"sampleContainer"]],ring:[3000,460]},
  mercury:{title:"SURFACE TEMPERATURE",steps:[["قِس الصخر اللي في الشمس",1360,480,"temperatureProbe"],["قِس الصخر اللي في الضلمة",1860,465,"temperatureProbe"]],ring:[2840,480]},
  venus:{title:"VENUS ROCK SAMPLE",kit:[["tongs",1510],["sampleContainer",1810]],steps:[["طلّع قطعة صغيرة بمطرقة الصخور",1220,240,"rockHammer"],["امسك القطعة بملقاط العينات",1640,410,"tongs"],["اقفل علبة العينات وحط البطاقة",2050,410,"sampleContainer"]],ring:[2810,330]},
  earth:{title:"OCEAN SIGNAL DIVE",steps:[["اسمع الإشارة تحت الميه وروح ناحيتها",2050,290,"hydrophone"]],ring:[2950,225]},
  mars:{title:"ANCIENT LAKEBED CORE",kit:[["sampleContainer",1580]],steps:[["طلّع عينة من جوه الصخر",1290,485,"drill"],["اقفل أنبوب العينة وحط بطاقة المكان",1810,475,"sampleContainer"]],ring:[3030,480]},
  jupiter:{title:"RADIATION CORRIDOR",steps:[["قِس الإشعاع في المكان الأول",1270,250,"radiation"],["قِس الإشعاع في المكان التاني",1840,440,"radiation"]],ring:[2870,190]},
  uranus:{title:"TILTED NAVIGATION",steps:[["روح للعلامة الأولى",1170,430,"navigation"],["روح للعلامة التانية",1670,210,"navigation"],["خليك على نفس الاتجاه",2030,360,"navigation"]],ring:[3040,270]},
  neptune:{title:"DARK RELAY",kit:[["flashlight",1110]],steps:[["نوّر المكان الضلمة",1400,330,"flashlight"],["دفّي الأجهزة الباردة",1900,230,"heater"]],ring:[2980,390]},
  saturn:{title:"HOME ORBIT",steps:[["قِس القوة المغناطيسية حوالين زحل",820,310,"magnetometer"]],ring:[3050,260]}
};

const TASK_SCIENCE={
  "moon:0":{subject:"شوية تراب من طرف الحفرة",measure:"التراب اللي جمعته",result:"تراب ناعم من سطح القمر",meaning:"تراب القمر فيه علامات من خبطات حصلت من زمان.",button:"خد التراب بالمغرفة",sample:"تراب من القمر",sampleStage:"collected"},
  "moon:1":{subject:"التراب جوه علبة العينات",measure:"حالة العينة",result:"SEALED & LABELED · محفوظة باسم الموقع",meaning:"الغطا والبطاقة بيحافظوا على العينة وبيوضحوا اتجمعت منين.",button:"اقفل العلبة وحط البطاقة",sample:"تربة قمرية",sampleStage:"sealed"},
  "mercury:0":{subject:"صخر في ضوء الشمس",measure:"رقم الحرارة",result:"الصخر سخن جدًا",meaning:"عطارد قريب من الشمس، عشان كده الصخر اللي في النور بياخد حرارة كبيرة.",button:"قِس الصخر المشمس"},
  "mercury:1":{subject:"صخر في الضلمة طول الوقت",measure:"رقم الحرارة",result:"الصخر أبرد بكتير من الصخر المشمس",meaning:"حوالي عطارد هوا قليل جدًا. مفيش هوا كفاية ينقل الحرارة من النور للضلمة.",button:"قِس الصخر في الضلمة"},
  "venus:0":{subject:"صخرة عملها بركان",measure:"القطعة اللي طلعتها",result:"قطعة جديدة من جوه الصخرة",meaning:"القطعة دي كانت جوه الصخرة، فحرارة السطح ما غيرتهاش كتير. عشان كده بتورّينا الصخرة كانت عاملة إزاي.",button:"اضرب ثلاث ضربات",sample:"قطعة من صخر بركاني",sampleStage:"released"},
  "venus:1":{subject:"قطعة الصخر السخنة",measure:"القطعة اللي مسكتها",result:"القطعة بقت جوه علبة العينات",meaning:"الملقاط بيخلي القفاز ما يلمسش القطعة. كده العينة تفضل نضيفة.",button:"امسكها بالملقاط",sample:"قطعة من صخر بركاني",sampleStage:"collected"},
  "venus:2":{subject:"القطعة جوه علبة العينات",measure:"العلبة",result:"العينة محفوظة وعليها بطاقة",meaning:"العلبة بتحمي العينة. والبطاقة بتقول اتجمعت منين.",button:"اقفل العلبة وحط البطاقة",sample:"قطعة من صخر بركاني",sampleStage:"sealed"},
  "earth:0":{subject:"إشارات تحت الميه",measure:"مكان أقوى إشارة",result:"عرفنا الحلقة فين",meaning:"الصوت بيمشي في الميه. لما نسمع أقوى إشارة، نعرف جاية منين.",button:"اسمع وروح ناحية الأقوى"},
  "mars:0":{subject:"صخر فيه طبقات عند طرف المكان الجاف",measure:"العينة اللي طلعها المثقاب",result:"عينة فيها طبقات من جوه الصخر",meaning:"كل طبقة فيها تراب وحبات مختلفة. ده بيساعد العلماء يعرفوا هل الميه القديمة جابت التراب للمكان ده.",button:"طلّع أنبوب العينة",sample:"عينة من جوه صخر المريخ",sampleStage:"collected"},
  "mars:1":{subject:"أنبوب العينة",measure:"الأنبوب",result:"العينة مقفولة وجاهزة للفحص",meaning:"الغطا بيمنع تراب السطح يدخل العينة. والبطاقة بتقول العينة اتجمعت منين.",button:"اقفل الأنبوب وحط البطاقة",sample:"عينة من جوه صخر المريخ",sampleStage:"sealed"},
  "jupiter:0":{subject:"الإشعاع قرب المشتري",measure:"رقم الإشعاع",result:"الرقم عالي قرب المشتري",meaning:"الإشعاع طاقة ممكن تؤذيك. قوة المشتري المغناطيسية بتجمع طاقة وجسيمات صغيرة حواليه.",button:"قِس المكان الأول"},
  "jupiter:1":{subject:"المكان البعيد",measure:"رقم الإشعاع",result:"الرقم أقل من المكان الأول",meaning:"لما نبعد عن الإشعاع العالي، الطريق يبقى أأمن.",button:"قِس المكان التاني"},
  "uranus:0":{subject:"العلامة الأولى",measure:"اتجاه الطريق",result:"الطريق مايل ناحية أورانوس",meaning:"أورانوس بيلف وهو مايل على جنبه، عشان كده الطريق حواليه بيبان مايل.",button:"شغّل جهاز الاتجاه"},
  "uranus:1":{subject:"العلامة التانية",measure:"اتجاه الطريق",result:"العلامتين بيشاوروا لنفس الاتجاه",meaning:"لما نقارن علامتين، نعرف الاتجاه الصح.",button:"قارن العلامتين"},
  "uranus:2":{subject:"الطريق حوالين أورانوس",measure:"الاتجاه",result:"الاتجاه ثابت وصحيح",meaning:"لازم نعرف اتجاهنا كويس لأن أورانوس بيلف وهو مايل على جنبه.",button:"خليك على نفس الاتجاه"},
  "neptune:0":{subject:"مكان ضلمة وسط سحب نبتون",measure:"السحب اللي ظهرت",result:"ظهرت سحب بعيدة بتتحرك بسرعة",meaning:"نور الكشاف خلانا نشوف السحب البعيدة.",button:"شغّل الكشاف"},
  "neptune:1":{subject:"الأجهزة الباردة",measure:"حرارة الجهاز",result:"الجهاز دفي وبقى جاهز يشتغل",meaning:"نبتون بعيد جدًا عن الشمس، عشان كده الأجهزة بتبرد وبتحتاج الدفاية.",button:"شغّل الدفاية"},
  "saturn:0":{subject:"القوة المغناطيسية حوالين زحل",measure:"رقم القوة",result:"حوالي 21 ميكروتسلا قرب السحب",meaning:"الميكروتسلا وحدة بنقيس بيها القوة المغناطيسية. القوة دي بتغيّر طريق الجسيمات الصغيرة حوالين زحل.",button:"قِس القوة"}
};
const SAMPLE_RECORDS=[
  {planet:"moon",name:"تراب من القمر",available:"moon:0",collected:"moon:0",sealed:"moon:1"},
  {planet:"venus",name:"قطعة من صخر بركاني",available:"venus:0",collected:"venus:1",sealed:"venus:2"},
  {planet:"mars",name:"عينة من جوه صخر المريخ",available:"mars:0",collected:"mars:0",sealed:"mars:1"}
];
...
class World {
  ...
  draw(ctx,game,time){if(this.id==="space"){this.drawSolarSystem(ctx,game,time);return}const orbit=this.planet.mode==="orbit";if(this.id==="uranus")this.drawUranusIce(ctx,time);else if(!orbit){const tones={moon:["#8c8d8d","#4d5054"],mercury:["#9a958d","#282727"],venus:["#aaa081","#5f594b"],earth:["#d9c78e","#746f5c"],mars:["#a06d50","#40383a"]}[this.id]||[this.planet.ground,"#2b2524"],terrain=ctx.createLinearGradient(0,500,0,this.height);terrain.addColorStop(0,tones[0]);terrain.addColorStop(1,tones[1]);ctx.fillStyle=terrain;ctx.beginPath();ctx.moveTo(0,this.groundAt(0));for(let x=0;x<=this.width;x+=35)ctx.lineTo(x,this.groundAt(x));ctx.lineTo(this.width,this.height);ctx.lineTo(0,this.height);ctx.fill();for(const dust of this.id==="mars"?[]:this.dust){const ground=this.groundAt(dust.x),wide=7+dust.r*5;ctx.fillStyle=this.id==="mercury"?(dust.r%2?"rgba(255,228,174,.2)":"rgba(8,7,7,.4)"):this.id==="venus"?(dust.r%2?"rgba(255,246,207,.13)":"rgba(58,52,42,.18)"):this.id==="earth"?(dust.r%2?"rgba(255,240,190,.18)":"rgba(92,78,57,.14)"):dust.r%2?"rgba(255,235,205,.12)":"rgba(22,14,12,.2)";ctx.beginPath();ctx.ellipse(dust.x,ground-dust.r,wide,dust.r*2.2,-.18,Math.PI,Math.PI*2);ctx.fill();if(["moon","mercury","mars"].includes(this.id)&&dust.r===3){ctx.strokeStyle=this.id==="mercury"?"rgba(8,7,7,.52)":"rgba(20,14,12,.24)";ctx.lineWidth=2;ctx.beginPath();ctx.ellipse(dust.x,ground+3,wide*1.7,wide*.38,0,0,Math.PI*2);ctx.stroke()}}}else this.drawCloudDeck(ctx,time);
    ...
    for(const step of this.steps||[]){
      ...
      if(!game.cinematic&&game.missions.remaining()[0]===step&&Math.hypot(game.player.x-step.x,game.player.y-step.y)<420){ctx.fillStyle="#fff1c2";ctx.font="13px Changa";ctx.textAlign="center";ctx.fillText("استخدم الأداة هنا",step.x,step.y-78)}
    }
...
class UIManager {
  ...
  requiredTool(id){const item=ITEMS[id],current=ITEMS[this.game.state.equipped],location=this.game.state.inventory.includes(id)?"من الشنطة":this.game.state.locker.includes(id)?"من خزانة المركبة":"من صندوق الموقع";this.toast(`${current.name} مش الأداة المطلوبة هنا. جهّز ${item.name} ${location}؛ ${item.purpose}`);for(const element of [$("#backpack-btn"),$("#equipped-readout")]){if(!element)continue;clearTimeout(element.toolTimer);element.dataset.required=item.name;element.classList.add("tool-needed");element.toolTimer=setTimeout(()=>element.classList.remove("tool-needed"),2300)}}
  map(){
  ...
  backpack(){
    ...
    const sampleRows=SAMPLE_RECORDS.filter(record=>state.missionSteps.includes(record.available)).map(record=>{const sealed=state.missionSteps.includes(record.sealed),collected=state.missionSteps.includes(record.collected),status=sealed?"محفوظة وعليها بطاقة":collected?"جوه العلبة · محتاجة تتقفل وتتحط عليها بطاقة":"موجودة في الموقع · محتاجة تتجمع";return `<div class="sample-row ${sealed?"sealed":""}"><span>${sealed?"✓":collected?"→":"◇"}</span><div><b>${record.name}</b><small>${PLANETS[record.planet].name} · ${status}</small></div></div>`}).join(""),samples=sampleRows?`<div class="sample-list"><h3>العينات</h3>${sampleRows}</div>`:"";
    this.open(`<div class="tech-title"><div><small>أدوات رائد الفضاء</small><h2>شنطة الأدوات</h2></div><b>${state.inventory.length} من 6 · الوزن ${this.game.inventoryWeight()} كجم</b></div><div class="inventory-layout"><div><div class="inventory-slots">${slots}</div>${samples}<h3>خزانة المركبة · ${state.locker.length}</h3><div class="inventory-slots">${state.locker.map(slot).join("")}</div></div><div id="item-inspector" class="item-inspector"></div></div>`,true);
...
class Game {
  ...
  detectNearby(){
    ...
    const prompt=$("#interaction-prompt");prompt.classList.toggle("visible",Boolean(this.near));if(this.near){const labels={talk:"اتكلم",tool:"خد الأداة",task:"استخدم الأداة هنا",ring:"اتكلم مع الحلقة",science:"صوّر بكاميرا الاستكشاف"};prompt.querySelector("span").textContent=this.near.type==="destination"?PLANETS[this.near.id].en:labels[this.near.type]||"المركبة: دعم الحياة وإقلاع"}
  }
  interact(){
    ...
    if(object.type==="destination")this.selectDestination(object.id);
      ...
      if(this.state.equipped!=="camera"){this.ui.toast("جهّز كاميرا الاستكشاف من الشنطة");return}
  ...
  collectTool(object){
    ...
    const button=id==="sampleContainer"?"حط علبة العينات في الشنطة":"حط الأداة في الشنطة";this.ui.open(`<div class="item-found"><small>لقيت أداة للمهمة!</small>${this.ui.instrumentVisual(id)}<h2>${item.name}</h2><p><strong>بتعمل إيه؟</strong> ${item.purpose}</p><p><strong>هستخدمها إزاي؟</strong> ${item.use}</p><b>${carried?"الأداة جاهزة في شنطة الأدوات":"الأداة محفوظة في خزانة المركبة"} · 100%</b><button class="primary-btn" id="continue-item">${button} [E]</button></div>`);this.ui.onContinue=()=>this.ui.close();$("#continue-item").onclick=this.ui.onContinue;this.updateHUD();
  }
  ...
  missionStatus(){
    ...
    const step=this.missions.remaining()[0];if(step&&!this.inventory.owned(step.tool))return{code:"الأداة المطلوبة",text:`دور على ${ITEMS[step.tool].name}`,progress:10};
